      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto mt-4 lg:mt-0">
          ...
          <select
            ...
            className="bg-transparent glass border border-black/10 dark:border-white/10 text-sm rounded-xl px-3 pr-8 focus:outline-none focus:border-[var(--color-stabilo)] transition-colors h-11 cursor-pointer appearance-none"
        ...
        {filteredTxs.length === 0 ? (
          ...
          <div className="divide-y divide-black/5 dark:divide-white/5">
            {filteredTxs.map((tx: any, i: number) => {
              ...
              const catName = cat.name || tx.category_id || (tx.tx_type === 'Income' ? 'Pemasukan' : 'Pengeluaran');
              ...
              return (
              <div key={tx.id || i} className="group flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-5 hover:bg-white/5 dark:hover:bg-white/[0.03] transition-all duration-300 gap-4 lg:gap-6 relative hover:shadow-[0_4px_24px_rgba(0,0,0,0.1)] rounded-xl m-1 border border-transparent hover:border-black/5 dark:hover:border-white/5">
